...
plt.plot(x_ax, pa_out_psd, color='blue')
plt.plot(x_ax, x_psd, color='red')
# plt.plot(x_ax, psd, color='blue')
plt.xticks(np.arange(1.90, 1.99 + 0.01, 0.01))
plt.ylim([-70, 20])
plt.xlim([1.91, 1.97])
plt.legend(["Сигнал передатчика, TX", "Полезный сигнал на приёмнике, RX"], fontsize=fontsize, loc='upper right')
